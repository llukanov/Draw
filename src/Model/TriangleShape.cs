...
namespace Draw
{
    ...
    public class TriangleShape : Shape
    {
        ...
        /// <summary>
        /// Връща върховете на равнобедрен триъгълник, вписан в RectangleF.
        /// </summary>
        private PointF[] GetTrianglePoints()
        {
            return new PointF[]
            {
                new PointF(Rectangle.Left + Rectangle.Width / 2, Rectangle.Top), // Връх горе
                new PointF(Rectangle.Left, Rectangle.Bottom),                    // Ляв долен
                new PointF(Rectangle.Right, Rectangle.Bottom)                    // Десен долен
            };
        }
